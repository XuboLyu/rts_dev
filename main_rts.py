...
from map_generator import Map, MAP_WIDTH, MAP_HEIGHT
import time
...
if __name__ == "__main__":
    ...
    map = Map(MAP_WIDTH, MAP_HEIGHT, screen)
    while True:
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONUP:
                if button_single.isClicked():
                    print("clicking single player mode ...")
                if button_multi.isClicked():
                    print("clicking multiple players mode ...")
                if button_quit.isClicked():
                    print("clicking quit button ...")
                    pygame.quit()
                    quit()
